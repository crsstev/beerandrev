...
class Command(BaseCommand):
    ...
    def get_images_dir(self):
        return Path(settings.STATIC_ROOT) / 'images'
    ...
    def delete_cover_image(self, cover_path):
        ...
        try:
            ...
            filepath = self.get_images_dir() / filename
    ...
    def handle(self, *args, **options):
        ...
        login_resp = requests.post(login_url, json={"username": AMP_USER, "password": AMP_PASS, "token": "", "rememberMe": False}, headers={"Accept": "application/json"}, verify=False)
        ...
        instances_resp = requests.post(instances_url, json={"SESSIONID": session_id}, headers={"Accept": "application/json"}, verify=False)
